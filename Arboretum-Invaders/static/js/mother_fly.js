export default class MotherFly {

  constructor(speed, health, prng) {
    this.width = 80;
    this.height = 80;
    this.pos_y = 75 + Math.floor(prng.getNum() * (200 - this.height));
    this.image_left = document.getElementById("img_fly_left");
    this.image_right = document.getElementById("img_fly_right");
